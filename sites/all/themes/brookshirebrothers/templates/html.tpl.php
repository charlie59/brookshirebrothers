...
<?php else: ?>
  ...
  ?>
    ...
    <head>
      ...
      <?php print $styles; ?>
        <!--[if lt IE 9]>
        <link rel="stylesheet" type="text/css" href="<?php echo url(path_to_theme(), ['absolute' => TRUE]); ?>/ie.css"/><![endif]-->
        <!--[if IE]>
        <script type="text/javascript" src="<?php echo url(path_to_theme(), ['absolute' => TRUE]); ?>/js/ie.js"></script><![endif]-->
<!--//--><![CDATA[//><!--
(function(h,o,t,j,a,r){
  h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
  h._hjSettings={hjid:"205436",hjsv:6};
...
//--><!]]>
    ...
    <div id="wrapper">
      <?php else: ?>
        ...
        <script type="text/javascript" src="//6311223.collect.igodigital.com/collect.js"></script>
        <script type="text/javascript">
          etmc.push(['setOrgId', '6311223'])
          etmc.push(['trackPageView'])
        </script>
        <!-- added April 9 2018 per KBrown -->
        <script type="text/javascript" src="//6235051.collect.igodigital.com/collect.js"></script>
        <script type="text/javascript">
