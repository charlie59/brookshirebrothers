	...
	<section class="store-section google-map-holder">
		<div class="store-info">
			...
			<?php if ($node->field_weekly_ad['und'][0]['value']==1):?>
				<a href="/weekly-ad?store=<?php echo $node->field_number_store['und'][0]['value'];?>" class="btn-weekly">Weekly Ad</a>
			<?php endif;?>
			<?php if (isset($node->field_prescription_refill_link['und'][0]['value'])):?>
				<a href="<?php echo $node->field_prescription_refill_link['und'][0]['value'];?>" target="_blank" class="btn-refill">Refill Prescription</a>
			<?php endif;?>
				<a href="#" class="btn-map">Map</a>
				<a class="map-box" href="#"><span class="map-txt">Map</span><img src="/sites/all/themes/brookshirebrothers/images/map-img1.jpg" alt=""></a>
			</div>
		</div>
		<!-- store -->
		<div class="detail-box">
			...
			<dl>
				...
				<dd><a class="tel" href="tel:<?php echo $node->field_store_phone['und'][0]['value'];?>"><?php echo $node->field_store_phone['und'][0]['value'];?></a></dd>
				<?php endif;?>
			</dl>
		</div>
		<!-- pharmacy -->
		...
		<div class="detail-box">
			...
			<dl>
				...
				<dd><a class="tel" href="tel:<?php echo $node->field_pharmacy_phone['und'][0]['value'];?>"><?php echo $node->field_pharmacy_phone['und'][0]['value'];?></a></dd>
				<?php endif;?>
		...
		<div class="detail-box">
			<strong class="title"><?php print t('FLU SHOTS');?></strong>
			<dl>
				<dt class="long-text"><?php print t('Contact the Pharmacy');?></dt>
				<dd></dd>
			</dl>
		</div>
		<?php endif;?>
		...
		<div class="detail-box">
			...
			<dl>
				...
				<?php endif;?>
				<?php if (isset($node->field_subway_hours['und'][0]['value'])):?>
				<dt><?php print t('Subway Hours:');?></dt>
				<dd><?php echo $node->field_subway_hours['und'][0]['value']?></dd>
				<?php endif;?>
			</dl>
		</div>
		<?php endif;?>
		...
		<div class="detail-box">
			...
			<dl>
				...
				<dt><?php print t('Mr. Payroll Director:');?></dt>
				<dd><?php echo $node->field_mr_payroll_director['und'][0]['value']?></dd>
			</dl>
		</div>
		<?php endif;?>
	</section>
